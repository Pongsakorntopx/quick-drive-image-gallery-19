...
const thaiFonts: Font[] = [
  ...
  { id: "thasadith", name: "Thasadith", class: "font-thasadith" },
  { id: "moul", name: "Moul", class: "font-moul" },
  { id: "battambang", name: "Battambang", class: "font-battambang" },
  { id: "dangrek", name: "Dangrek", class: "font-dangrek" },
  { id: "thai-sans-neue", name: "Thai Sans Neue", class: "font-thai-sans-neue" },
  { id: "noto-sans-thai", name: "Noto Sans Thai", class: "font-noto-sans-thai" },
  { id: "noto-serif-thai", name: "Noto Serif Thai", class: "font-noto-serif-thai" },
];
...
const thaiHandwritingFonts: Font[] = [
  ...
  { id: "moul", name: "Moul", class: "font-moul" },
  { id: "suwannaphum", name: "Suwannaphum", class: "font-suwannaphum" },
  { id: "koh-santepheap", name: "Koh Santepheap", class: "font-koh-santepheap" },
  { id: "bokor", name: "Bokor", class: "font-bokor" },
  { id: "fasthand", name: "Fasthand", class: "font-fasthand" },
  { id: "moul-pali", name: "Moul Pali", class: "font-moul-pali" },
  { id: "metal", name: "Metal", class: "font-metal" },
  { id: "siemreap", name: "Siemreap", class: "font-siemreap" },
  { id: "taprom", name: "Taprom", class: "font-taprom" },
  { id: "odor-mean-chey", name: "Odor Mean Chey", class: "font-odor-mean-chey" },
];
...
const englishFonts: Font[] = [
  ...
  { id: "roboto-slab", name: "Roboto Slab", class: "font-roboto-slab" },
  { id: "crimson-text", name: "Crimson Text", class: "font-crimson-text" },
  { id: "spectral", name: "Spectral", class: "font-spectral" },
  { id: "barlow", name: "Barlow", class: "font-barlow" },
  { id: "comfortaa", name: "Comfortaa", class: "font-comfortaa" },
  { id: "josefin-sans", name: "Josefin Sans", class: "font-josefin-sans" },
  { id: "cabin", name: "Cabin", class: "font-cabin" },
  { id: "arvo", name: "Arvo", class: "font-arvo" },
];
...
const englishHandwritingFonts: Font[] = [
  ...
  { id: "gloria-hallelujah", name: "Gloria Hallelujah", class: "font-gloria-hallelujah" },
  { id: "patrick-hand", name: "Patrick Hand", class: "font-patrick-hand" },
  { id: "coming-soon", name: "Coming Soon", class: "font-coming-soon" },
  { id: "handlee", name: "Handlee", class: "font-handlee" },
  { id: "architects-daughter", name: "Architects Daughter", class: "font-architects-daughter" },
  { id: "kalam", name: "Kalam", class: "font-kalam" },
  { id: "covered-by-your-grace", name: "Covered By Your Grace", class: "font-covered" },
  { id: "comic-neue", name: "Comic Neue", class: "font-comic-neue" },
  { id: "gochi-hand", name: "Gochi Hand", class: "font-gochi-hand" },
];
...
const additionalFonts: Font[] = [
  ...
  { id: "signika", name: "Signika", class: "font-signika" },
  { id: "russo-one", name: "Russo One", class: "font-russo-one" },
  { id: "fjalla-one", name: "Fjalla One", class: "font-fjalla-one" },
  { id: "lobster", name: "Lobster", class: "font-lobster" },
  { id: "yanone-kaffeesatz", name: "Yanone Kaffeesatz", class: "font-yanone-kaffeesatz" },
  { id: "noto-sans-jp", name: "Noto Sans JP", class: "font-noto-sans-jp" },
  { id: "mukta", name: "Mukta", class: "font-mukta" },
  { id: "catamaran", name: "Catamaran", class: "font-catamaran" },
  { id: "abel", name: "Abel", class: "font-abel" },
  { id: "karla", name: "Karla", class: "font-karla" },
  { id: "syne", name: "Syne", class: "font-syne" },
  { id: "cormorant-garamond", name: "Cormorant Garamond", class: "font-cormorant-garamond" },
  { id: "outfit", name: "Outfit", class: "font-outfit" },
  { id: "playfair-display-sc", name: "Playfair Display SC", class: "font-playfair-display-sc" },
];
